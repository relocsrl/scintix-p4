 ...
 *
 * Scintix P4 board adaptation — display (EK79007) + touch (GT911).
 * Derived from the espressif/esp32_p4_function_ev board.
 */
#include <string.h>
#include "esp_log.h"
...
static const char *TAG = "SCINTIX_P4_SETUP_DEVICE";
