...
# Ethernet iperf Example on UART 0- Tested on ESP-IDF 6.0.1

This example is configured to output the console trace via **UART0**, available through the 6-pin programmer connector directly on the SCINTIX P4 board.
